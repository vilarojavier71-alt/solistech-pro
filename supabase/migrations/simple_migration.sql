-- ============================================================================
-- SOLISTECH PRO V2 - MIGRACIONES SIMPLIFICADAS
-- ============================================================================
...
CREATE POLICY "Subsidies are viewable by everyone" ON subsidies FOR SELECT USING (true);
...
CREATE POLICY "Municipal benefits are viewable by everyone" ON municipal_tax_benefits FOR SELECT USING (true);
