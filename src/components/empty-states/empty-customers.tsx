 ...
 * 
 * Pantalla vac√≠a cuando no hay clientes.
...
export function EmptyCustomers() {
    return (
        ...
        >
            ...
            {/* CaracterÌsticas de importaciÛn */}
            <div className="bg-slate-900/50 border border-slate-700 rounded-lg p-6 max-w-lg">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sm font-medium text-slate-300">ImportaciÛn Inteligente</p>
                </div>
                <ul className="text-xs text-slate-400 text-left space-y-2">
                    <li>‚úÖ Formatos soportados: .xlsx, .xls, .csv</li>
                    <li>? DetecciÛn autom·tica de columnas</li>
                    <li>? M·ximo 10.000 filas por archivo</li>
                    <li>‚ö†Ô∏è Aseg√∫rate de que la primera fila tiene los nombres de columnas</li>
                </ul>
            </div>

            {/* Ayuda */}
            <p className="text-xs text-slate-500 mt-6">
                øNecesitas ayuda con la importaciÛn?{' '}
